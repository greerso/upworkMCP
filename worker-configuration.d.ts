/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8dcc6d00249f3cad0da5ef30b2d42eaa)
// Runtime types generated with workerd@1.20260625.1 2025-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	UPWORK_TOKENS: KVNamespace;
	OAUTH_KV: KVNamespace;
	ASSETS: Fetcher;
	MyMCP: DurableObjectNamespace<import("./src/index").UpworkMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UpworkMCP";
	}
